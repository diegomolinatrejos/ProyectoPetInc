function validarFormularioRegistroDispositivos() {
    ...
    formularioRegistroDispositivos.addEventListener('submit', function (e) {
        ...
        const nombreDispositivo = document.getElementById('nombre').value.trim();
        const numeroSerieDispositivo = document.getElementById('numero').value.trim();
...
function validarFormularioEdicionDispositivos() {
    ...
    formularioEdicionDispositivos.addEventListener('submit', function (e) {
        ...
        const nombreDispositivoEditar = document.getElementById('nombre').value.trim();
        const numeroSerieDispositivoEditar = document.getElementById('numero').value.trim();
